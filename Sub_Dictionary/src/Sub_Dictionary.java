...
/*
*This program takes any text file chosen by the user, reads it, and takes every single word in it
*and put it in an array list inheritor, and then sorts all the words in alphabetical order and only have words
*with no punctuation marks or anything and then create a dictionary and print it into a subDictionary.txt file
*
*/
